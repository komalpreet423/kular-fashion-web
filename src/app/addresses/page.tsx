              ...
              >
                ...
                <div className="flex space-x-4 mt-4">
                  <button
                    ...
                    className="text-primary hover:bg-primary hover:text-white px-4 py-2 transition-all duration-300 cursor-pointer border-none rounded-lg"
                  >
                    Edit
                  </button>
                  <button
                    onClick={() => handleDeleteAddress(address)}
                    className="text-red-500 hover:bg-white hover:text-red-500 hover:border-red-500 px-4 py-2 transition-all duration-300 cursor-pointer border-2 rounded-lg"
                  >
                    Delete
                  </button>
                </div>
        ...
        >
          <div className="relative bg-white p-6 rounded-lg shadow-md w-[80%] max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <button
              ...
              className="absolute top-3 right-3 text-gray-600 hover:text-red-500 text-xl cursor-pointer"
            >
              &times;
            </button>
